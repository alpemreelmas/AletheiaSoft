...
using AletheiaSoft.Application.Common.Security;
using AletheiaSoft.Application.TodoLists.Commands.CreateTodoList;
using AletheiaSoft.Application.TodoLists.Commands.PurgeTodoLists;
...
public class PurgeClientsTests : BaseTestFixture
{
    [Test]
